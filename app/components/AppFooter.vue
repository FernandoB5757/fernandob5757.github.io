            ...
            <div class="flex flex-col items-center w-full my-20">
                ...
                <div class="flex flex-col items-center gap-6 mb-8">
                    <!-- <div
                        ...
                        <a href="javascript:void(0)" class="text-gray-600 hover:text-gray-900 dark:text-white">Blog</a>
                        <a href="javascript:void(0)" class="text-gray-600 hover:text-gray-900 dark:text-white">Resources</a>
